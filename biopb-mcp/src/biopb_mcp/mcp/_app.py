...
_BASE_INSTRUCTIONS = (
    ...
    "auto-starts, and every other kernel tool fails until it returns. Call it "
    "again to recover after a failure, or after the user closes the viewer "
    "window. A user asking to start, open, or launch biopb or napari is asking "
    "for this tool.\n"
    "\n"
