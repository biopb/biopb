...
# (a LIST of STRUCT(array_id, dim_labels, shape, chunk_shape, dtype) -- one per
# tensor; `dtype`/`shape_summary` are just the first-tensor projection).
# `chunk_shape` is the transfer grid the tensor is delivered on.
