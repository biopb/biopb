...
policy (`proto/biopb/tensor/descriptor.proto`), [cloud-storage-support.md](cloud-storage-support.md)
...
- **Cloud/unresolved sources.** Enumerating members is a content read, so an
  ...
  ([cloud-storage-support.md](cloud-storage-support.md): multi-file content-membership formats degrade
