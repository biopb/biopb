...
def _make(client, name="cache:plan", shape=(4, 4), chunk=(2, 2)):
...
class TestThePlanIsTheGrid:
    def test_a_pending_tensor_is_planned_not_read(self, client):
    ...
    def test_the_write_and_the_read_hold_the_same_tickets(self, client):
    ...
    def test_a_slice_asks_for_only_the_chunks_it_touches(self, client):
    ...
    def test_a_slice_is_snapped_outward_to_whole_chunks(self, client):
...
class TestUploadChunkTakesAChunk:
    def test_bounds_that_are_not_a_chunk_are_refused_with_the_grid(self, client):
    ...
    def test_a_box_spanning_two_chunks_is_refused_too(self, client):
        desc = _make(client)
    ...
    def test_a_chunk_of_the_grid_lands(self, client):
        desc = _make(client)
        client.upload_chunk(
...
class TestUploadArrayOnAPlan:
    def test_the_whole_array_is_sealed(self, client):
        desc = _make(client)
    ...
    def test_a_slice_hint_uploads_that_region_and_does_not_seal(self, client):
    ...
    def test_an_open_ended_slice_stop_comes_from_the_declared_shape(self, client):
    ...
    def test_a_slice_hint_of_the_wrong_rank_is_refused(self, client):
        desc = _make(client)
    ...
    def test_the_two_halves_together_fill_the_tensor(self, client):
